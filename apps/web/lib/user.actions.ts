...
export async function createUser(input: CreateUserInput): Promise<User> {
  try {
    ...
    throw new UserOperationError("Failed to create user", "create", error);
  }
}
...
export async function getUsersWithRoles(): Promise<User[]> {
  try {
    ...
    throw new UserOperationError("Failed to fetch users", "fetch", error);
  }
}
...
export async function updateUserRole(
  ...
  try {
    ...
    throw new UserOperationError("Failed to update user role", "update", error);
  }
}

export async function deleteUser(
  clerkId: string,
): Promise<{ database: User; clerk: boolean }> {
  try {
    validateClerkId(clerkId);
    ...
    throw new UserOperationError("Failed to delete user", "delete", error);
  }
}
